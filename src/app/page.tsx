  ...
  return (
    <main>
      <div id="first-section">
        <section className="container custom-container mx-auto h-fit">
          <div className="head-section lg:w-min">
            <div className="pin-banner">
              <div className="mb-5 lg:w-min">
                <div className="mt-24 md:mt-36 flex justify-start items-center gap-3">
      ...
      <footer id="footer" className="footer relative">
        <div className="h-full w-full flex flex-col justify-start items-start container custom-container mx-auto gap-10 md:gap-24 pt-16">
