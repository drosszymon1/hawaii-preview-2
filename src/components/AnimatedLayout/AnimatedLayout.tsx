            ...
            mm.add("(min-width: 768px)", () => {
                ...
                palms.forEach(palm => {
                    palmAnimation.fromTo(`#${palm}`, {
                        ...
                        x: palm.startsWith("first") || palm.startsWith("second") ? 70 : -80,
                        y: palm.startsWith("first") || palm.startsWith("second") ? -60 : 0,
                        scale: 1.1,
                        rotate: palm.startsWith("first") || palm.startsWith("second") ? 8 : -10,
                    }, 0)
                });
